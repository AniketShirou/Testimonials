...
const Testimonial = (props) =>{
  ...
  return(
    <div className="w-[85vw] md:w-[700px] bg-white rounded-md flex flex-col justify-center items-center mt-10 p-10 transition-all duration-200 hover:shadow-xl">
        ...
        <div className="flex text-3xl mt-5 gap-1 text-violet-400 font-bold justify-center">
        ...
        <div>
            <button onClick={supriseHandler} className="bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer mt-3 px-10 py-2 rounded-md font-bold text-white text-lg">Suprise Me</button>
        </div>
    </div>
  )
}
